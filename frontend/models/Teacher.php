...
class Teacher extends \yii\db\ActiveRecord
{
    ...
    public function importData($file){
        ...
        foreach ($dataModel as $key =>$item){
            ...
            $arr[$key]['Teacher']['student_id'] = $item->student_id;
            $arr[$key]['Teacher']['test_id'] = $item->test_id;
            ...
            $arr[$key]['Teacher']['home_address'] = $item->home_address;
            $arr[$key]['Teacher']['admission_time'] = $item->admission_time;
            $arr[$key]['Teacher']['political_landscape'] = $item->political_landscape;
            $arr[$key]['Teacher']['type'] = $item->type;
            $arr[$key]['Teacher']['pic'] = 'default';
        }
